...
export default function Home() {
  ...
  return (
    <div className="flex md:w-3/4 w-11/12 items-center justify-center flex-col-reverse md:flex-row my-0 md:my-8 md:items-center md:justify-center antialiased bg-grid-white/[0.02] overflow-hidden">
